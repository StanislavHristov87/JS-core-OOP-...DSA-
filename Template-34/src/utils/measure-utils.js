...
export const measure = {
  ...
  arrayReduceRight: 'array.reduceRight',
...
export const createArrayMethodsObserver = () => {
  ...
  const _reduceRight = Array.prototype.reduceRight;
  ...
  Array.prototype.reduceRight = function (...params) {
    result[measure.arrayReduceRight]++;
    result.order.push({
      type: measure.arrayReduceRight,
      value: clone(params),
    });

    return _reduceRight.apply(this, params);
  };
  ...
  return () => {
    ...
    Array.prototype.reduceRight = _reduceRight;
